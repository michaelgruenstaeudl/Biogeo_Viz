...
starBEAST_prefix = paste("/run/media/michael/6974AEDF6DB4DD0C/05_Project_CommT_Jan2015/03_KFdist_distributions/01_input/01_starBEAST_geneTrees/CommT.Jan2015.swapped.sim.", s, ".gene", sep="")


####################################################
## Loading data sets of treatment group "swapped" ##
####################################################
#BEAST_prefix = paste("/run/media/michael/6974AEDF6DB4DD0C/05_Project_CommT_Jan2015/03_KFdist_distributions/01_input/02_BEAST_GeneTrees/CommT.Jan2015.regular.sim.", s, ".gene", sep="")
#starBEAST_prefix = paste("/run/media/michael/6974AEDF6DB4DD0C/05_Project_CommT_Jan2015/03_KFdist_distributions/01_input/01_starBEAST_geneTrees/CommT.Jan2015.regular.sim.", s, ".gene", sep="")
