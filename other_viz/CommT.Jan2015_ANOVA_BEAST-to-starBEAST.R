...
# Global variables
setwd("/run/media/michael/6974AEDF6DB4DD0C/05_Project_CommT_Jan2015/03_KFdist_distributions/02a_output/")
fn_prefixes = c("BEAST.to.starBEAST_KFdist_noswap_sim.")
#fn_prefixes = c("BEAST.to.starBEAST_KFdist_g1swap_sim.")

#setwd("/run/media/michael/6974AEDF6DB4DD0C/05_Project_CommT_Jan2015/03_KFdist_distributions/02b_output/")
...
for (inFn in inFns) {
    ...
    out_handle[[inFn]] = list("KruskalWallis" = KW_result,
